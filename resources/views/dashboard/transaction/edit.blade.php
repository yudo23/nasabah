...
<div class="row">
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="{{route('dashboard.transaction.update',$result->id)}}" method="post" autocomplete="off" onsubmit="return confirm('Apakah anda yakin ingin mengirim data ini?')" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control select2" name="nasabah_id" style="width: 100%;">
                                        ...
                                        <option value="{{$row->id}}" @if(old('nasabah_id',$result->nasabah_id) == $row->id) selected @endif>{{$row->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control datetimepicker" name="date" placeholder="Tanggal Transaksi" value="{{old('date',$result->date)}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control select2" name="debit_credit_status" style="width: 100%;" required>
                                        ...
                                        <option value="{{$index}}" @if(old('debit_credit_status',$result->debit_credit_status) == $index) selected @endif>{{$row}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control select2" name="description" style="width: 100%;" required>
                                        ...
                                        <option value="{{$row}}" @if(old('description',$result->description) == $row) selected @endif>{{$row}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="amount" placeholder="Amount" value="{{old('amount',$result->amount)}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
